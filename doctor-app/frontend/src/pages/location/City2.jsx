    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: '300px', marginBottom: '20px' }}>
          <img
            src="https://i.pinimg.com/736x/4b/99/0b/4b990b00ddfa9363aecc61bc608e2eb3.jpg"
            alt="Hospital"
            style={{
              width: '100%',
              height: 'auto',
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => window.open('https://www.google.com/maps?q=123,Main+Road,+Mumbai,+India', '_blank')}
              style={{
