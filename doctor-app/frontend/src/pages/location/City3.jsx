    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: '300px', marginBottom: '20px' }}>
          <img
            src="https://i.pinimg.com/474x/1c/06/4c/1c064c8634b98ce1e664a10c73ba73e8.jpg"
            alt="Hospital"
            style={{
              width: '100%',
              height: 'auto',
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => window.open('https://www.google.com/maps?q=123,Main+Road,+Delhi,+India', '_blank')}
              style={{
