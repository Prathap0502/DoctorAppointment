    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: '300px', marginBottom: '20px' }}>
          <img
            src="https://i.pinimg.com/736x/78/a0/fa/78a0fa3357df2391fc9b38895fb3d5ca.jpg"
            alt="Hospital"
            style={{
              width: '100%',
              height: 'auto',
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => window.open('https://www.google.com/maps?q=123,Main+Road,+Bangalur,+India', '_blank')}
              style={{
